...
\todo[inline]{Richard should run t-tests on this data to actually test the hypothesis that there is no influnce, using the human proxemic values published in the sociological literature. If there is no influence we might as well use those, instead of the values reported here..}
...
In order to complete the state representation as discussed in Section \ref{sec:defining_the_state-space}, the final distances of the approaches of the interaction targets towards the robot $P$ have been clustered into the 3 distance spaces $\mathcal{H}:P \rightarrow \mathcal{S}_d$. %TODO formal notation
...
In our conducted experiments, the test participants have pressed the feedback button a total number of 65 times. %That we have data on!
...
%discuss result Twente experiment
...
%(8.3770746216287666, 0.13664231226048021)
