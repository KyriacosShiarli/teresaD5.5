...
\centering
%\vspace{-3.3mm}
    \includegraphics[width=0.35\textwidth]{figures/gridworld.png}
%\vspace{-4mm}
...
%  hspace{-16pt}
	\centering
	\begin{subfigure}[b]{0.4\columnwidth}
    \includegraphics[scale = 0.29]{figures/gp.pdf}
    \end{subfigure}
    \begin{subfigure}[b]{0.4\columnwidth}
    \includegraphics[scale = 0.29]{figures/bp.pdf}
  	\end{subfigure}
